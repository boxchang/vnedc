...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('collection', '0022_auto_20240719_0933'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='param_type_process_type', to='collection.process_type')),
