    ...
    def execute(self):
        ...
        for runcard in runcards:
            ...
            if lot_number not in files:  # 沒有資料才塞
                ...
                if file_id:
                    # MEASURE_ITEM
                    self.insert_measure_item(file_id, ' 1.Cuon biên 2.Co tay 3.Bàn tay 4.Ngón tay', lot_number, 4, 1)  # 卷唇
                    ...
                    self.insert_measure_item(file_id, '5.D Ngón tay', lot_number, 4, 2)  # 指尖
